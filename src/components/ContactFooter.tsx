          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mb-24 z-10 w-full max-w-2xl justify-center">
            ...
            >
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-16 h-16 sm:w-[88px] sm:h-[88px] rounded-full bg-surface/50 backdrop-blur-md border border-white/10 flex items-center justify-center hover:bg-[#333] hover:text-white transition-all duration-300 hover:border-transparent group shadow-xl"
              >
                <GithubIcon className="w-7 h-7 sm:w-8 sm:h-8 group-hover:scale-110 transition-transform" />
              </a>
            </motion.div>
          </div>

          {/* Footer Bar */}
          <div className="w-full flex justify-center items-center mt-12 pt-8 border-t border-white/10">
