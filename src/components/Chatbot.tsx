...
const PORTFOLIO_INFO = {
  ...
  projects: [
    ...
    },
    {
      ...
      desc: "Bảng điều khiển cập nhật nhanh chóng và chính xác tình hình thời tiết.",
...
- Các dự án tiêu biểu (Selected Works):
  ...
  4. Ví Nhỏ Finance: Ứng dụng quản lý tài chính cá nhân thông minh, thân thiện dành riêng cho người Việt. Link: https://vinho-delta.vercel.app/src/pages/homepage.html
